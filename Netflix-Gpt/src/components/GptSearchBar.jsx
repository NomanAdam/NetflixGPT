...
const GptSearchBar = () => {
 ...
 return (
  <div className="absolute top-24 left-0 right-0 mx-auto w-full max-w-2xl px-4 flex flex-col items-center z-10">
   <form
    className="w-full bg-white flex items-center p-1 sm:p-2 rounded-full shadow-lg border border-gray-200 focus-within:ring-2 focus-within:ring-red-600 focus-within:border-transparent transition-all"
   ...
   >
    ...
    <button
     className="bg-red-600 hover:bg-red-700 active:scale-95 transition-all px-3 sm:px-6 py-2.5 rounded-full text-white font-semibold shadow-md text-sm md:text-base whitespace-nowrap"
