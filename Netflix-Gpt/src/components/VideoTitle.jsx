...
function VideoTitle({ title, overview }) {
 return (
  <div className="absolute top-0 left-0 w-full h-screen text-white bg-linear-to-r from-black/70 via-black/30 to-transparent flex flex-col justify-center px-14">
